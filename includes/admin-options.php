...
$panel_args = [
    'title'           => 'Shipper Options',
    'option_name'     => 'shipper_options',
    'slug'            => 'shipper-options-panel',
    'user_capability' => 'manage_options',
];

$panel_settings = [
    'shipper_base_url' => [
        'label'       => esc_html__( 'API endpoint', 'shipper' ),
        'type'        => 'text'
    ],
    'default_product_title' => [
        'label'       => esc_html__( 'Default Product title', 'shipper' ),
        'type'        => 'text'
    ],
];

if (class_exists('SHIPPER_Options_Panel')) {
    new SHIPPER_Options_Panel( $panel_args, $panel_settings );
};